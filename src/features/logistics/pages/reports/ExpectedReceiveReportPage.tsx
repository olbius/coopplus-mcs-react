...
export const ExpectedReceiveReportPage: FC = () => {
  ...
  const handleSubmit = useCallback(() => {
    setParams({
      serviceName: 'olapReceivedPurchaseReport',
      olapType: 'GRID',
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', flexGrow: 1, overflow: 'auto' }}>
      <PageHeader breadcrumbs={[{ label: 'Logistics' }, { label: 'Báo cáo', path: '/logistics/reports' }, { label: 'Nhập kho dự kiến' }]} />
      <Box sx={{ px: 2, pb: 2 }}>
        ...
        <Paper sx={{ p: 2 }}>
          <Typography variant="subtitle2" sx={{ mb: 1 }}>Nhập kho theo đơn mua hàng</Typography>
