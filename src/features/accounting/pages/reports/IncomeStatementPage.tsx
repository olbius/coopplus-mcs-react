...
export const IncomeStatementPage: FC = () => {
  ...
  const handleSubmit = useCallback(() => {
    setParams({
      serviceName: 'getIncomeStatement',
      olapType: 'GRID',
      dateType,
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', flexGrow: 1, overflow: 'auto' }}>
      <PageHeader breadcrumbs={[{ label: 'Kế toán' }, { label: 'Báo cáo', path: '/accounting/reports' }, { label: 'Báo cáo thu nhập' }]} />
      <Box sx={{ px: 2, pb: 2 }}>
        ...
        <Paper sx={{ p: 2 }}>
          <Typography variant="subtitle2" sx={{ mb: 1 }}>Báo cáo kết quả kinh doanh</Typography>
